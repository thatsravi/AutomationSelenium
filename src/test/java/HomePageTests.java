...
public class HomePageTests  extends TestBase {
    ...
    public void TC_2_verifyHomePageandBuy2Items()
    {
       ...
       String twoProduct= pages.addToCartPage.checkProductinCartPage();
        ...
        Double totaProducltValue=Double.parseDouble(cartValue);
        if(totaProducltValue>30 && totaProducltValue<60)
        {
        ...
        String completeOrder=pages.checkOutCompletePage.titleCompleteheader();
